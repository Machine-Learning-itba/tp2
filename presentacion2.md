...
section.lead {
  background: linear-gradient(160deg, #0D1117 0%, #1A1040 40%, #2D1B69 100%);
  color: white;
  text-align: center;
}
...
<p style="margin-top: 30px; font-size: 14pt; color: #C4B5FD;">Pedro Curti · Felipe Hiba · Gonzalo Shariff</p>

<p style="margin-top: 20px;">72.75 Aprendizaje Automático — ITBA</p>

<p style="margin-top: 10px; font-size: 11pt;">Mayo 2026</p>
...
<div class="callout">
<p><strong style="color: #6EE7B7;">B: 357 (62.7%)</strong> — Benigno</p>
<p><strong style="color: #F472B6;">M: 212 (37.3%)</strong> — Maligno</p>
...
Raw Data (569×30)&ensp;→&ensp;Feature Selection (569×17)&ensp;→&ensp;Train/Test Split 80/20&ensp;→&ensp;StandardScaler (dentro de CV)
</div>
...
<!-- SLIDE 3b: Correlación antes/después -->

# Feature Selection: Matriz de Correlación

![w:800](outputs/correlation_before_after.png)

- **78 pares** con |r| > 0.70 en el dataset original
- Se eliminaron **13 features** por multicolinealidad (|r| > 0.80)
- De cada grupo correlacionado se conserva la feature con mayor |r(diagnosis)|

---

<!-- SLIDE 3c: Correlación con diagnosis -->

# Correlación de Features con Diagnosis

![w:550](outputs/diagnosis_correlation.png)

- Features con |r| ≥ 0.5 (violeta) son las más discriminativas
- `concave_points_worst` (r = +0.79) y `perimeter_worst` (r = +0.78) lideran
- Features con |r| < 0.1 (ej: `texture_se`, `symmetry_se`) barely aportan señal
...
- <em style="color: #F472B6;">FN:</em> tumor maligno → clasificado benigno → **no recibe tratamiento** → consecuencia grave
...
> **Sensibilidad / Recall (TPR)** <span class="badge">MÉTRICA PRINCIPAL</span>
...
<p style="font-size: 13px; color: #8B949E;">Recall y Especificidad están en trade-off — aumentar uno tiende a bajar el otro</p>
...
<p style="font-size: 13px; color: #8B949E;">CV estratificado 5-fold en todos los modelos.</p>
...
<p style="font-size: 13px; color: #8B949E;">Gap bajo + CV alto = buen trade-off sesgo-varianza</p>
